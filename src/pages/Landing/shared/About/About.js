...
const aboutMeInfo = [
  `Hi! I’m a front end developer with a strong passion for building web applications from conception to completion. I specialize in JavaScript, HTML, CSS, React, and Styled Components, with the goal of building scalable applications that meet the demands of todays' users. 
  `,
  `
